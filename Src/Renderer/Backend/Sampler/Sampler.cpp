...
void Sampler::Create(const SamplerProps& props)
{
	...
	VkResult result = vkCreateSampler(gGraphics->GetDevice()->Device, &sampler_info, nullptr, &InternalSampler);
...
void Sampler::Destroy()
{
	...
	vkDestroySampler(gGraphics->GetDevice()->Device, InternalSampler, nullptr);
	InternalSampler = nullptr;
}
